...
POST
/auth/register
Create a host or guest account
Public
POST
/auth/login
...
GET
/listings
Get the authenticated host’s listings
Host
POST
/listings
...
GET
/listings/search
Search available listings by location, dates, guest count, and optional distance
Guest
GET
/bookings
Get the authenticated guest’s bookings
Guest
POST
/bookings
